// ============================================
// TEST FINAL - Atelier A2: jeder/jede/jedes + Häufigkeit
// Claudia Toth · 15 întrebări (jeder declinare + adverbe frecvență + täglich + traducere)
// ============================================

const finalTestData = [
    // 📐 jeder (4)
    { type: 'multiple', category: '📐 jeder', question: '„în fiecare zi" se spune:', options: ['jeden Tag', 'jeder Tag', 'jedem Tag', 'jedes Tag'], correct: 'jeden Tag', explanation: 'Timpul e la Akkusativ → jeden Tag (der Tag e masculin).' },
    { type: 'luckentext', category: '📐 jeder', question: 'Completează (Akkusativ de timp):', sentence: 'Ich lerne <strong>______</strong> Tag Deutsch.', translation: 'în fiecare zi (Akk!)', accept: ['jeden'], correct: 'jeden', explanation: 'jeden Tag (Akkusativ masculin).' },
    { type: 'multiple', category: '📐 jeder', question: '„jeder" se declină ca:', options: ['articolul der/die/das', 'un substantiv', 'un verb', 'o prepoziție'], correct: 'articolul der/die/das', explanation: 'jeder = der-Wort → se declină ca der/die/das.' },
    { type: 'luckentext', category: '📐 jeder', question: 'Completează (helfen + Dativ):', sentence: 'Ich helfe <strong>______</strong> Kollegen.', translation: 'fiecărui coleg (Dativ masc.)', accept: ['jedem'], correct: 'jedem', explanation: 'helfen cere Dativ → jedem (masculin).' },

    // 📊 Frecvență (4)
    { type: 'multiple', category: '📊 Frecvență', question: '100% (mereu) =', options: ['immer', 'oft', 'selten', 'nie'], correct: 'immer', explanation: 'immer = mereu (100%).' },
    { type: 'multiple', category: '📊 Frecvență', question: '0% (niciodată) =', options: ['nie', 'manchmal', 'meistens', 'immer'], correct: 'nie', explanation: 'nie = niciodată (0%) — fără nicht!' },
    { type: 'luckentext', category: '📊 Frecvență', question: 'Completează (rar):', sentence: 'Wir gehen <strong>______</strong> ins Theater.', translation: 'rar', accept: ['selten'], correct: 'selten', explanation: 'selten = rar.' },
    { type: 'multiple', category: '📊 Frecvență', question: '„de obicei" =', options: ['meistens', 'manchmal', 'nie', 'immer'], correct: 'meistens', explanation: 'meistens = de obicei (~80%).' },

    // 📅 täglich & co. (4)
    { type: 'multiple', category: '📅 täglich & co.', question: '„zilnic" (un singur cuvânt) =', options: ['täglich', 'wöchentlich', 'monatlich', 'jährlich'], correct: 'täglich', explanation: 'täglich = zilnic (= jeden Tag).' },
    { type: 'multiple', category: '📅 täglich & co.', question: '„jede Woche" înseamnă același lucru cu:', options: ['wöchentlich', 'täglich', 'monatlich', 'jährlich'], correct: 'wöchentlich', explanation: 'jede Woche = wöchentlich (săptămânal).' },
    { type: 'luckentext', category: '📅 täglich & co.', question: 'Completează (o dată ___ săptămână):', sentence: 'Ich kaufe einmal <strong>______</strong> Woche ein.', translation: 'o dată pe săptămână', accept: ['pro'], correct: 'pro', explanation: 'einmal pro Woche = o dată pe săptămână.' },
    { type: 'multiple', category: '📅 täglich & co.', question: '„Cât de des?" =', options: ['Wie oft?', 'Wie viel?', 'Wie lange?', 'Wann?'], correct: 'Wie oft?', explanation: 'Wie oft? = cât de des (frecvență).' },

    // 🗣️ Traducere (3)
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Mă trezesc în fiecare zi la 7.', accept: ['ich stehe jeden tag um 7 uhr auf', 'ich stehe jeden tag um sieben uhr auf'], correct: 'Ich stehe jeden Tag um 7 Uhr auf.', explanation: 'jeden Tag (Akk) + aufstehen separabil (… auf).' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Nu mănânc niciodată carne.', accept: ['ich esse nie fleisch'], correct: 'Ich esse nie Fleisch.', explanation: 'nie = niciodată (fără nicht).' },
    { type: 'translate', category: '🗣️ Traducere', question: 'Traduceți în germană:', ro: 'Cât de des faci sport?', accept: ['wie oft machst du sport'], correct: 'Wie oft machst du Sport?', explanation: 'Wie oft …? = Cât de des …?' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre jeder & frecvență.</p>
            <ul class="test-info-list">
                <li>📐 jeder (4) · 📊 Frecvență (4) · 📅 täglich & co. (4) · 🗣️ Traducere (3)</li>
